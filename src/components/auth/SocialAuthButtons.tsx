    ...
    <div>
      <div className="mt-6 grid grid-cols-2 gap-3">
        ...
        <button
          type="button"
          disabled
          className="flex cursor-not-allowed items-center justify-center gap-2 rounded-xl border border-input-border bg-input-bg px-4 py-2.5 text-sm font-medium text-text-tertiary opacity-50"
        >
